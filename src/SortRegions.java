...
//		new Point(100, 320), new Point(170, 300), new Point(180, 170), new Point(230, 360), new Point(180, 350)};
	...
	static int [] clusterValesY;
	static int [] clusterValesY2;
	static int [] clusterValesX;
	...
	public static List<PointCluster> sortlist(List<PointCluster> clust) {
		...
		clusterValesY = new int[cNumber];
		clusterValesY2 = new int[cNumber];
		clusterValesX = new int[cNumber];
